...
export default function MathetesDetailError({
  error,
  reset,
}: {
  ...
  useEffect(() => {
    console.error("[MathetesDetailError]", error);
  ...
  return (
    <div className="px-8 py-16 max-w-2xl mx-auto text-center dark:text-[#e5e5e5]">
      ...
      <div className="mt-12">
        ...
        <h1 className="font-display text-2xl mb-3 dark:text-[#f0f0f0]">Unable to Load Entry</h1>
        <p className="text-[#231F1E]/60 dark:text-gray-400 max-w-sm mx-auto leading-relaxed mb-8">
          Something went wrong while loading this page. Please try again or browse the Mathetes fellowship updates.
        </p>
