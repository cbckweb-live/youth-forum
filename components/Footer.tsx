...
export default function Footer() {
  return (
    <footer className="bg-gray-100 dark:bg-[#1a1a1a] text-gray-700 dark:text-gray-300 mt-auto border-t border-gray-200 dark:border-[#2a2a2a]">
      ...
      <div className="grid grid-cols-1 md:grid-cols-5 gap-x-10 gap-y-10 px-8 pt-6 pb-2">
        ...
        */}
        <div className="md:min-w-[240px] flex flex-col items-center text-center">
          ...
          <h3 className="font-display text-lg mb-4 text-[#231F1E] dark:text-[#e5e5e5] leading-snug">
        ...
        <div className="md:pl-12">
          <h4 className="text-sm uppercase tracking-wide text-[#6B1F2A] dark:text-[#B84C5C] mb-4">
            Contact
          </h4>
          ...
          <div className="mt-4 flex gap-4" aria-label="Social media">
            <a
              ...
              aria-label="Facebook"
              className="text-gray-500 dark:text-gray-400 hover:text-[#6B1F2A] dark:hover:text-[#B84C5C] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#6B1F2A] transition-colors"
            >
        ...
        */}
        <div className="md:pl-12">
          ...
          <ul className="space-y-2 text-sm text-gray-600 dark:text-gray-400">
            <li>
              <Link href="/events" className="hover:text-[#6B1F2A] dark:hover:text-[#B84C5C] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#6B1F2A]">
                Upcoming Events
              </Link>
            </li>
            <li>
              <Link href="/events#past-events" className="hover:text-[#6B1F2A] dark:hover:text-[#B84C5C] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#6B1F2A]">
                Past Events
              </Link>
            </li>
          </ul>
        ...
        <div>
          <iframe
            ...
            className="mt-4 h-32 w-full rounded-lg border border-gray-200 dark:border-[#2a2a2a]"
            loading="lazy"
      ...
      <div className="border-t border-gray-200 dark:border-[#2a2a2a] px-8 py-6 flex flex-wrap justify-between gap-4 text-sm text-gray-500 dark:text-gray-400">
        <div className="flex items-center gap-6 flex-wrap">
          <div className="flex gap-6">
            <Link href="/office-bearers" className="hover:text-[#6B1F2A] dark:hover:text-[#B84C5C] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#6B1F2A]">
              Office Bearers
            </Link>
            <Link href="/mathetes" className="hover:text-[#6B1F2A] dark:hover:text-[#B84C5C] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#6B1F2A]">
              Mathetes
            </Link>
            <Link href="/gallery" className="hover:text-[#6B1F2A] dark:hover:text-[#B84C5C] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#6B1F2A]">
              Gallery
            </Link>
